...
export function HemySalePage() {
  const [isLoading, setIsLoading] = useState(true);
  const [error, setError] = useState<string | null>(null);

  const hemySaleUrl =
    'https://org47a0b99a.crm4.dynamics.com/main.aspx?appid=46bb0df2-988e-ec11-b400-0022489d8684&pagetype=dashboard&id=2701de60-8f2a-48a4-8262-4a35ca7441fa&type=system&_canOverride=true';
  ...
  const handleIframeError = () => {
    setError('Failed to load Hemy Sale. Please check your connection or permissions.');
    setIsLoading(false);
  };
        ...
        {isLoading && (
          <div className="flex h-full items-center justify-center bg-[#FAF8F2]">
            <div className="text-center">
              ...
              <p className="text-sm text-[#C4956A]">Loading Hemy Sale...</p>
            </div>
          </div>
        )}
