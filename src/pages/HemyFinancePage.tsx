...
export function HemyFinancePage() {
  ...
  const handleIframeError = () => {
    setError('Failed to load Hemy Finance. Please check your connection or permissions.');
    setIsLoading(false);
  };
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F2] text-[#021838]">
      <main className="h-screen w-full">
        {isLoading && (
          <div className="flex h-full items-center justify-center bg-[#FAF8F2]">
            <div className="text-center">
              ...
              <p className="text-sm text-[#C4956A]">Loading Hemy Finance...</p>
            </div>
          </div>
        )}
        ...
        <iframe
          src={hemyFinanceUrl}
          title="Hemy Finance - Business Central"
          style={{
            width: '100%',
            height: '100%',
            border: 'none',
